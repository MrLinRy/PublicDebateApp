...
//    [self.containerView addGestureRecognizer:self.tapRecognizer];
    ...
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(closeSlideMenu:)
                                                 name: Notify_CloseSildeMenu
                                               object: nil];
    [[NSNotificationCenter defaultCenter] addObserver: self
                                             selector: @selector(openSlideMenu:)
                                                 name: Notify_OpenSildeMenu
                                               object: nil];
}

-(void)closeSlideMenu:(NSNotification*)notification
{
    [self hideMenuAnimated:YES];
    
}

-(void)openSlideMenu:(NSNotification*)notification
{
